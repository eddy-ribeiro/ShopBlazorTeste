...
namespace BlazorShop.Api.Repositories
{
    public class ProdutoRepository : IProdutoRepository
    {
        ...
        {
            var produtos = await _context.Produtos.Include(p => p.Categoria).ToArrayAsync();
        ...
        {
            var produtos = await _context.Produtos.Include(c => c.Categoria).Where(p => p.CategoriaId == id).ToListAsync();
